...
const MisstionDetailPage = () => {
  ...
  return (
    <Layout showNavBar={false} showHeader={false}>
      <Page>
        <div id="back-button"><IoIosArrowBack size={18}/></div>
        <img src="https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyNDExMTlfNSAg%2FMDAxNzMxOTQ3Nzg0NDgz.sET_o7XTucDHjhJqr_7G0we7stnijLkLO_vjZ4dPRVcg.mxXwN_qyP6ITuzAUzoKajp48JNGPpvc0Syn-MQpfH08g.JPEG%2FIMG_3247.jpg&type=sc960_832" alt="미션사진"/>
        ...
        <TabMenu>
          ...
          <div
            className={activeTab === "certified" ? "active" : ""}
        ...
        <Footer>
          <Like><IoMdHeartEmpty size={22}/></Like>
