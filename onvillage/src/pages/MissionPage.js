    ...
    <Layout>
      <div className={style.missionPageBg}>
        ...
        <div className={style.categoryBtnBox}>
          <button className={style.categoryBtn} onClick={() => toggleBottomSheet('sort')}>{selectedSort}<IoCaretDownOutline className={style.categoryBtnImg}/></button>
          <button className={style.categoryBtn} onClick={() => toggleBottomSheet('category')}>{selectedCategory}<IoCaretDownOutline className={style.categoryBtnImg}/></button>
        </div>
        <MissionList />
      </div>
